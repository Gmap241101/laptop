...
for (const marker of ["'/api/users/signup/bootstrap'", "'/api/users/me/terms-consent/bootstrap'", 'accountLifecycleCompatibilityDisabled', "'firebase-auth-compatibility-preserved'", "'clerk-email-code'", "runtimeRevision: 'phase33-user-clerk-content-authority-20260811-2210'"]) assert.ok(appSource.includes(marker), marker);
