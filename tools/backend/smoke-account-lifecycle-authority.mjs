...
for (const marker of ["'/api/users/signup/bootstrap'", "'/api/users/me/terms-consent/bootstrap'", 'accountLifecycleCompatibilityDisabled', "passwordResetDelivery: 'firebase-auth-compatibility-preserved'", "runtimeRevision: 'phase32-auth-session-source-truth-20260811-2026'"]) assert.ok(appSource.includes(marker), marker);
