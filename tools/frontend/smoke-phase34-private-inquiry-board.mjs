...
for (const marker of [
  '비회원 문의 확인', '비회원 문의 작성', '문의 확인 비밀번호', '문의 확인 비밀번호 확인',
  '조회 방법', '이메일', '연락처', '비회원 문의 확인 비밀번호는 재설정할 수 없습니다.',
  '답변대기', '답변완료', '추가답변', '관리자 답변', '문의 등록', '문의 수정',
  'mk_laptop_guest_inquiry_access', 'window.sessionStorage',
