...
for (const marker of ['Clerk Staging Test · Phase 33', 'Phase 30 member status / rental restriction PostgreSQL authority + Firestore write mirror retirement', 'Admin member list source:', 'Phase 30 retirement error:', "top: '184px'"]) assert.ok(diagnostics.includes(marker), marker);
