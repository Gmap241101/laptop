...
assert.match(panel, /<col className="w-\[5%\]" \/>[\s\S]*<col className="w-\[7%\]" \/>[\s\S]*<col className="w-\[14%\]" \/>[\s\S]*<col className="w-\[12%\]" \/>[\s\S]*<col className="w-\[14%\]" \/>[\s\S]*<col className="w-\[11%\]" \/>[\s\S]*<col className="w-\[18%\]" \/>[\s\S]*<col className="w-\[19%\]" \/>/);
assert.match(panel, /inline-flex whitespace-nowrap rounded-full border px-2 py-0\.5 text-\[10px\] font-semibold/);
