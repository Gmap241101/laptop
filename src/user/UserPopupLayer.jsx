          ...
          <div className="space-y-2 sm:hidden">
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                className="min-w-0 flex-1 rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-xs font-semibold text-slate-600 outline-none transition focus:border-orange-400 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
