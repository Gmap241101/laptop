...
export const readAssetDomainCutoverConfig = ({
  ...
  const readEnabled = stagingEnabled && bool(env?.VITE_ASSET_POSTGRES_READ_ENABLED);
  const writeEnabled = stagingEnabled && bool(env?.VITE_ASSET_POSTGRES_WRITE_ENABLED);
