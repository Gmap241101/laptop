...
export const renderAppRoot = ({ runtimeSurface }) => {
  const rootElement = document.getElementById('root');
  if (!rootElement) throw new Error('React root element (#root) was not found.');

  document.documentElement.dataset.appSurface = runtimeSurface;

  ReactDOM.createRoot(rootElement).render(
    <React.StrictMode>
      <RootErrorBoundary>
        <App runtimeSurface={runtimeSurface} />
      </RootErrorBoundary>
      <DiagnosticsErrorBoundary>
        <ClerkStagingDiagnostics runtimeSurface={runtimeSurface} />
      </DiagnosticsErrorBoundary>
    </React.StrictMode>
  );
};
